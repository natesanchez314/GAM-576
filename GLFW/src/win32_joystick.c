...
static GLFWbool pollJoystickState(_GLFWjoystickWin32* js, int mode)
{
    ...
    else
    {
        ...
        if (sqrt((double)((double)xis.Gamepad.sThumbLX * (double)xis.Gamepad.sThumbLX +
            (double)xis.Gamepad.sThumbLY * (double)xis.Gamepad.sThumbLY)) >
            (double)XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE)
        {
        ...
        if (sqrt((double)((double)xis.Gamepad.sThumbRX * (double)xis.Gamepad.sThumbRX +
            (double)xis.Gamepad.sThumbRY * (double)xis.Gamepad.sThumbRY)) >
            (double)XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE)
        {
