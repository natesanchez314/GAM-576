...
#pragma pack(8)
    ...
    textureData CreateAndReturnTextureTGA(const char* const pFileName)
    {
        assert(pFileName);
    ...
    void gltReadPNGBits(const char *pFileName, textureData &textData)
    {
        ...
        textureData::TEXTURE_EFORMAT eFormat = textureData::TEXTURE_EFORMAT::EFORMAT_RGBA;
        textureData::TEXTURE_NCOMPONENT nComponents = textureData::TEXTURE_NCOMPONENT::NCOMPONENT_RGBA;
