...
namespace Azul
{
	...
	StringThis::StringThis(ShaderObject::Name status)
	{
		...
		case ShaderObject::Name::SKIN:
			strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(ShaderObject::SKIN));
			break;
		...
		case ShaderObject::Name::MIXER:
			strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(ShaderObject::MIXER));
			break;

		case ShaderObject::Name::WORLD:
			strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(ShaderObject::WORLD));
			break;
