...
namespace Azul
{
	...
	void Sphere::privMostSeparatedPointsOnAABB(int &min, int &max, Vec3 *pt, int numPts)
	{
	...
	void Sphere::privSphereOfSphereAndPt(Vec3 &p)
	{
	...
	void Sphere::privSphereFromDistantPoints(Vec3 *pt, int numPts)
	{
		assert(pt);
	...
	void Sphere::RitterSphere(Vec3 *pt, int numPts)
	{
		assert(pt);
