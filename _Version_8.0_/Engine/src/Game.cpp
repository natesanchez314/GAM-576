...
namespace Azul
{
	...
	void Game::LoadContent()
	{
		...
		ClipMan::Add(Clip::Name::MOUSEY_RUMBA, "Mousey_Rumba_Dancing.anim.proto.azul");
		ClipMan::Add(Clip::Name::MOUSEY_HIPHOP, "Mousey_Hip_Hop_Dancing.anim.proto.azul");
		Clip* mouseyClip = ClipMan::Add(Clip::Name::MOUSEY_GANGNAM, "Mousey_Gangnam_Style.anim.proto.azul");
	...
	void Game::Update(float)
	{
		...
		// Anim swaps for chicken bot
		if (InputMan::GetKeyboard()->GetKeyState(Keyboard::KEY_1))
		{
			fontA->UpdateMessage("Walk");
			pAnimControllerA->TransitionAnim(Clip::Name::BOT_WALK, 1.0f / 120.0f);
		}
		else if (InputMan::GetKeyboard()->GetKeyState(Keyboard::KEY_2))
		{
			fontA->UpdateMessage("Shot front");
			pAnimControllerA->TransitionAnim(Clip::Name::BOT_SHOT_FRONT, 1.0f / 120.0f);
		}
		else if (InputMan::GetKeyboard()->GetKeyState(Keyboard::KEY_3))
		{
			fontA->UpdateMessage("Hit front");
			pAnimControllerA->TransitionAnim(Clip::Name::BOT_HIT_FRONT, 1.0f / 120.0f);
		}

		// Anim swaps for mousey
		if (InputMan::GetKeyboard()->GetKeyState(Keyboard::KEY_4))
		{
			fontB->UpdateMessage("Rumba dancing");
			pAnimControllerB->TransitionAnim(Clip::Name::MOUSEY_RUMBA, 1.0f / 120.0f);
		}
		else if (InputMan::GetKeyboard()->GetKeyState(Keyboard::KEY_5))
		{
			fontB->UpdateMessage("Hip Hop dancing");
			pAnimControllerB->TransitionAnim(Clip::Name::MOUSEY_HIPHOP, 1.0f / 120.0f);
		}
		else if (InputMan::GetKeyboard()->GetKeyState(Keyboard::KEY_6))
		{
			fontB->UpdateMessage("Gangnam style");
			pAnimControllerB->TransitionAnim(Clip::Name::MOUSEY_GANGNAM, 1.0f / 120.0f);
		}
