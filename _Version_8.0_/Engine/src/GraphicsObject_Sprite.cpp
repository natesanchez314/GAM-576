...
namespace Azul
{
	...
	void GraphicsObject_Sprite::UpdateImage(const Rect& rect)
	{
		this->pImage->imageRect.x = rect.x;
		this->pImage->imageRect.y = rect.y;
		this->pImage->imageRect.width = rect.width;
		this->pImage->imageRect.height = rect.height;
